...
<i18n>
  {
    "en": {
      "funds": {
        "title": "Funds",
        "description": "Transfer your Surprise points to OySy pearls.",
        "total": "Total",
        ...
        "requestBazoDescription": "You can exchange your Surprise points with OySy pearls.",
    ...
    "de": {
      "funds": {
        ...
        "description": "Tauschen Sie Surprise Punkte gegen OySy Perlen.",
        "amount": "Anzahl Surprize Punkt",
        "address": "Token des Surprise-Kontos",
        "requestBazo": "In Perlen umwandeln",
        "requestBazoDescription": "Tauschen Sie Ihre Surprise Punkte gegen OySy Perlen.",
