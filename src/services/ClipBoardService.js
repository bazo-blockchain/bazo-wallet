...
const ClipBoardService = function (app, Translation) {
  'use strict';

  var textClassName = 'text-to-copy';
  var buttonClassName = 'js-copy-btn';
  var allowButtonTextToChange = false;
  var afterCopyText = {
    desktop: 'Copy again',
    iPad: 'Now tap the text, then ',
    iPhoneOriPod: 'Now tap ',
      ...
      if (copyBtn) {
        copyBtn.addEventListener('click', function () {
          ...
          if (copyItem) {
            ...
            throwErr(
              'You dont have an element with the class: ' +
              textClassName +
        ...
        throwErr(
          'You dont have a <button> with the class: ' +
          buttonClassName +
          ' Please check the cheval README.'
        );
      }
